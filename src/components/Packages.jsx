...
export default function Packages() {
  ...
  return (
    <section className="relative py-24 lg:py-32 bg-canvas overflow-hidden" id="pricing">
      {/* Background */}
            ...
            >
              ...
              <motion.button
                ...
                className={`w-full py-3.5 rounded-xl font-bold text-sm tracking-wide transition-all duration-300 ${
                  plan.highlight
                    ? 'bg-gradient-to-r from-accent to-yellow-500 text-gray-900 shadow-[0_4px_20px_rgba(212,175,55,0.4)] hover:shadow-[0_8px_30px_rgba(212,175,55,0.5)]'
