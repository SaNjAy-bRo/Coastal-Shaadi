    ...
    <section className="relative min-h-screen flex items-center overflow-hidden" id="home">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full flex flex-col lg:flex-row items-center justify-between gap-10 pt-28 pb-20">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-serif font-bold text-white leading-[1.1] mb-6">
            Finding{' '}
            <span className="relative inline-block">
              <span className="text-accent italic font-light">the right person</span>
            ...
            <br />
            made{' '}
            <span className="relative text-accent italic font-light">
              Easy
              <motion.span animate={{ rotate: [0, 10, -10, 0] }} transition={{ repeat: Infinity, duration: 4 }} className="absolute -top-3 -right-5 text-lg">✦</motion.span>
            </span>
          </h1>

          <p className="text-base sm:text-lg lg:text-xl text-white/70 max-w-xl leading-relaxed mb-10 mx-auto lg:mx-0">
