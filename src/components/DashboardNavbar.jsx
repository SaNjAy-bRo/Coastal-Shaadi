...
import { LayoutDashboard, User, Heart, Star, Ban, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex overflow-x-auto py-0 space-x-1 text-sm font-medium" style={{ scrollbarWidth: 'none' }}>
          {links.map((link) => (
            <NavLink
              key={link.path}
              to={link.path}
