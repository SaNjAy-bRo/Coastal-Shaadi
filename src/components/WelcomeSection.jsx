            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 font-medium">Enquiry</p>
                    <p className="text-sm font-bold text-gray-800">+91 96321 26045</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-gray-800">hello@coastalshaadi.com</p>
                  </div>
                </div>
              </div>
            </motion.div>
